...
//////////////////////////////////////////////////////////////////////////////
// Socket members
inline Socket::Socket() : m_handle(-1), m_ExceptionEnabled(false) {
}

inline Socket::Socket(int handle) : m_handle(handle), m_ExceptionEnabled(false) {
}
...
inline void Socket::EnableException(bool value) {
  m_ExceptionEnabled = value;
}

inline bool Socket::ExtensionEnabled() const {
