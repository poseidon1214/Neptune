...
#ifndef COMMON_SYSTEM_CONCURRENCY_EVENT_H_
#define COMMON_SYSTEM_CONCURRENCY_EVENT_H_
...
// Typically, you use this class when threads need exclusive access to a
// resource.
//
// Important
...
class AutoResetEvent {
 ...
 public:
  ...
  bool TimedWait(int64_t timeout_ms);
...
// waiting threads, or threads that wait on the event after it has been
// signaled, can be released while the object's state is signaled.
...
#endif  // COMMON_SYSTEM_CONCURRENCY_EVENT_H_
