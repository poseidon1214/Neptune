...
inline std::string HexEncodeBuffer(
  const void* data, size_t size,
  bool uppercase = false
) {
  std::string str;
...
/// @brief hex encoding, and return result as string
/// @param sp data to be encoded, can be std::string or const char*
/// @param uppercase whether yield upper case result
/// @return encoded result as string
//inline std::string HexEncodeString(StringPiece sp)
//{
//    std::string str;
//    HexEncodeTo(sp.data(), sp.size(), &str, false);
//    return str;
//}
