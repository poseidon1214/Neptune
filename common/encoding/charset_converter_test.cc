...
TEST(CharsetConverter, Empty) {
  gdt::CharsetConverter utf8_to_gbk("UTF-8", "GBK");
...
//   gdt::CharsetConverter cc(from, to);
// }
...
const char kUtf8Text[] =
    "\xe4\xb8\xad\xe6\x96\x87\xe8\xbd\xac\xe6\x8d"
    "\xa2\xe6\xb5\x8b\xe8\xaf\x95\x0a";
...
TEST(CharsetConverter, GbkToUtf8) {
  gdt::CharsetConverter gbk_to_utf8("GBK", "UTF-8");
  std::string converted;
