...
protected:
    ...
    static const char* kPbTestFileName;
...
const char* RecordIoJnaTest::kPbTestFileName = "recordio_jna.pbrecordio";
...
{
    {
        RecordWriter *writer = OpenRecordWriter(kTestFileName, 0, 0);
