...
#ifndef COMMON_FILE_RECORDIO_RECORDIO_JNA_H_
#define COMMON_FILE_RECORDIO_RECORDIO_JNA_H_

#include <stdint.h>
#include "common/system/dynamic_library.h"
...
DLL_EXPORT RecordReader* OpenSplitRecordReader(const char* filename,
                                               uint32_t options,
...
#endif  // COMMON_FILE_RECORDIO_RECORDIO_JNA_H_
