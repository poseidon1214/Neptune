...
#ifndef COMMON_ENCODING_VARIANT_INTEGER_H
#define COMMON_ENCODING_VARIANT_INTEGER_H

#include <assert.h>
#include <limits.h>
#include <stddef.h>
#include "app/qzap/common/recordio/internal/int_cast.h"
#include "app/qzap/common/recordio/internal/platform_features.h"
#include "app/qzap/common/recordio/internal/type_traits.h"
...
public:
    ...
    static int Encode(ArgType value, void* buffer, size_t size)
    {
        ...
        return base128::HandleSign<sign>::Encode(
            int_cast<Type>(value), buffer, size);
    }
...
#endif // COMMON_ENCODING_VARIANT_INTEGER_H
