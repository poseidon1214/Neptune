...
#ifndef COMMON_FILE_RECORDIO_RECORDIO_H_
#define COMMON_FILE_RECORDIO_RECORDIO_H_

#include <stdio.h>
#include <iosfwd>
//#include "app/qzap/common/base/deprecate.h"
#include "app/qzap/common/base/scoped_ptr.h"
#include <stdint.h>
//#include "app/qzap/common/base/string/string_piece.h"
#include "app/qzap/common/compress/block_compression_codec.h"
//#include "app/qzap/common/file/file_fwd.h"
...
struct RecordReaderOptions {
    ...
    explicit RecordReaderOptions(uint32_t options = DEFAULT_OPTIONS,
                                 int64_t start = -1, int64_t end = -1)
        : m_options(options), m_start(start), m_end(end) {
    }
...
struct RecordWriterOptions {
    ...
    explicit RecordWriterOptions(
        ...
        uint32_t compression_codec = common::BlockCompressionCodec::NONE)
        : m_options(options)
...
private:
    ...
    // We provide a interface to seek to  the offset of file.
    ...
    //common::File* m_input_common_file;
    ...
    // different codec.
    scoped_ptr<common::BlockCompressionCodec> m_compression_codec;
};
...
private:
    ...
    // Only one of the following would be used.
    // TODO(hansye): switch to File interface once it's ready.
    //common::File* m_output_common_file;
...
#endif  // COMMON_FILE_RECORDIO_RECORDIO_H_
