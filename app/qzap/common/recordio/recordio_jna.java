...
public class recordio_jna {
    public static class RecordReader {
        ...
        public RecordReader(String filename, int options, long start, long end) {
            open(filename, options, start, end);
        }
        ...
        public boolean open(String filename, int options, long start, long end) {
            recordReaderContext =
                RecordIOLibrary.INSTANCE.OpenSplitRecordReader(filename, options, start, end);
            return recordReaderContext != null;
        }
    ...
    private interface RecordIOLibrary extends Library {
        RecordIOLibrary INSTANCE =
            (RecordIOLibrary) Native.loadLibrary("recordio_jna",
                                                 RecordIOLibrary.class);

        Pointer OpenRecordReader(String filename, int options);
        Pointer OpenSplitRecordReader(String filename, int options, long start, long end);
